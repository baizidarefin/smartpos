                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <img style="max-width: 100px;height:auto;margin-right:25px" src="{{ asset('public/frontend/images') }}/{{$settings->logo}}" />
                                        </div>
                                        @endif
                                        <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center">
                                        @if(isset($settings->logo))
                                        <div>
                                            <img style="max-width: 50px;height:auto;margin-right:25px" src="{{ asset('public/frontend/images') }}/{{$settings->favicon}}" />
                                        </div>    
                                        @endif
                                        <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="home_page" class="form-control">
                                            ...
                                            <option @if($settings->home_page == $page->id) selected @endif value="{{$page->id}}">{{$page->page_name}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
