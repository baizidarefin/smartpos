            ...
            <form id="payment-form" action="{{ url('/place-order') }}" class="d-block validation" method="post" @if(isset($stripe)) data-cc-on-file="false" data-stripe-publishable-key="{{$publishable_key}}" @endif>
                ...
                <div class="row">
                    <div class="col-md-7 mt-3 cus-details">
                        ...
                        <div class="row shipping_details @if(auth()->user()) d-none @endif">
                            <div class="col-12 mb-3 mt-2">
                                <label>{{trans('file.Name')}} *</label>
                                <input class="form-control" type="text" name="shipping_name" id="name" value="{{ $customer->name ?? $def_address->name ?? 'test'}}" required>
                            </div>
                    ...
                    <div class="col-md-5 mt-3 cart">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="button sm theme-color pl-0 pr-0 collapsed" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">{{trans('file.I have a coupon')}}</div>
                                <div class="collapse" id="collapseExample">
                                    <div class="input-group coupon-code">
                                        ...
                                        <button type="submit" class="button sm style1 apply-coupon">
                        ...
                        <div class="payment-options text-center">
                            @if(isset($pages))
                            <div class="res-box custom-control custom-checkbox text-center mt-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="hidden" id="warehouse_id" name="warehouse_id" value="{{$ecommerce_setting->warehouse_id}}">
                                <input type="hidden" id="biller_id" name="biller_id" value="{{$ecommerce_setting->biller_id}}">
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 'success') {
                            ...
                            if (response.coupon_type == 'percentage') {
                                ...
                                var free_shipping_from = parseFloat('{{$ecommerce_setting->free_shipping_from}}');
                                var flat_rate_shipping = parseFloat('{{$ecommerce_setting->flat_rate_shipping}}');
