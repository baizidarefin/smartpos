                                ...
                                <li class="has-dropdown">
                                    ...
                                    <ul class="dropdown sidebar {{ (request()->is('/')) ? 'show' : '' }}">
                                        ...
                                        @foreach($all_categories as $category)
                                            ...
                                            <li class="has-dropdown"><a href="{{ url('shop') }}/{{ $category->slug }}">@if(isset($category->icon))<img src="{{ asset('public/images/category/icons/') }}/{{ $category->icon }}" alt="{{ $category->name }}">@endif <span>{{ $category->name }}</span></a>
                                                <ul class="dropdown">
                                                    @foreach($categories as $cat)
                                                    <li><a href="{{ url('shop') }}/{{ $cat->slug }}">@if(isset($cat->icon))<img src="{{ asset('public/images/category/icons/') }}/{{ $cat->icon }}" alt="{{ $cat->name }}">@endif <span>{{ $cat->name }}</span></a></li>
                                                    @endforeach
                                                </ul>
                                            </li>
                                            @else
                                            <li><a href="{{ url('shop') }}/{{ $category->slug }}">@if(isset($category->icon))<img src="{{ asset('public/images/category/icons/') }}/{{ $category->icon }}" alt="{{ $category->name }}">@endif <span>{{ $category->name }}</span></a>
                                            </li>
                                            @endif
                                            @endif
                                            @php $i++ @endphp
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-6 d-flex pt-3 pb-3 align-items-center">
                    <div class="promo-icon pr-2">
                        <img src="{{asset('public/frontend/images/features')}}/{{$widget->feature_icon}}" alt="{{$widget->feature_title}}">
                    </div>
