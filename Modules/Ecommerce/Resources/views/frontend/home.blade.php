                    ...
                    <div id="hero-slider" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <a class="carousel-item @if($key == 0) active @endif" href="{{$slider->link}}">
                                <div class="single-carousel-item" style="background-image: url('{{ asset('public/frontend/images/slider/desktop/') }}/{{$slider->image1}}'); background-size: cover; background-position: center;"></div>
                            </a>
                            @endforeach
                        </div>
