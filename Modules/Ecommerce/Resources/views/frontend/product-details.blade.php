...
@section('image'){{ asset('images/product/large') }}/{{$product->image}}@endsection
            ...
            @endif
                ...
                <div class="slider-wrapper">
                    <div class="slider-for">
                        ...
                        <div class="slider-for__item ex1" data-src="{{ asset('public/images/product/large') }}/{{$image}}">
                            <img src="{{ asset('public/images/product/large') }}/{{$image}}" alt="{{ $product->name }}" />
                        </div>
                        @endforeach
                    </div>
            ...
            <div class="col-md-6 offset-md-1 mt-5">
                ...
                <div class="item-share mt-3">
                    ...
                    <ul class="footer-social d-inline pad-left-15">
                        ...
                        <li>
                            <a href="http://pinterest.com/pin/create/button/?url={{url('/product')}}/{{$product->slug}}/{{$product->id}}&media={{ asset('images/product/large') }}/{{$product->image}}&description={{ $product->meta_title ?? $product->name }}" target="_blank">
