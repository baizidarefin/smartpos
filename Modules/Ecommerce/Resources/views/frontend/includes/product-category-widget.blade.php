    ...
    <section class="product-tab-section">
        <div class="container-fluid">
            ...
            @if($widget->product_category_type == 'slider')
            <div class="product-slider-wrapper swiper-container" data-loop="{{$widget->category_slider_loop}}" data-autoplay="{{$widget->category_slider_autoplay}}" data-autoplay-speed="{{$widget->category_slider_autoplay_speed}}">
